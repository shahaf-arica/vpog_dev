...
def run_download(cfg_dataset: DictConfig) -> None:
    ...
    target_path = (
            cfg_dataset.local_dir / "train_pbr_web"
        )
    snapshot_download(
        ...
        local_dir="megapose_partial",  # where to save them
...
def download(cfg: DictConfig) -> None:
    ...
    #     # url = f"{cfg_data.source_url}/megapose-{dataset_name}/train_pbr_web/"
    ...
    #     logger.info("---" * 100)
    target_path = (
        cfg_data.root_dir / "megapose_partial"
    )
