...
class VPOGDataset:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # For validation, set length to enable proper iteration
        set_length = (mode == 'val')
        self.web_dataloader = IterableWebSceneDataset(web_dataset, set_length=set_length)
        ...
        logger.info(f"  Mode: {mode}, Augmentation: {self.rgb_augmentation}, Debug: {self.debug_mode}")
...
if __name__ == "__main__":
    ...
    for test_config in test_configs:
        ...
        try:
            ...
            try:
                # Figure: Original full RGB + centered query + cropped query + templates with angles
                # Figure: Original full RGB + centered query + cropped query + templates with angles
                ...
                plt.suptitle(f'{test_config["name"]}: VPOG Batch Visualization\n' + 
                             'Check patch_cls analysis above!',
                             fontsize=12, fontweight='bold')
                plt.tight_layout()
                
                # Save with dataset name
                output_filename = f'batch_{dataset_name}_seed{SEED}.png'
